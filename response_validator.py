...
def _has_real_catalog_pitch(text: str) -> bool:
    normalized = (text or "").lower()
    has_mbps = bool(re.search(r"\d+\s*mbps", normalized))
    has_price = _contains_pattern(normalized, CATALOG_PRICE_PATTERNS)
    return has_mbps and has_price
...
def build_fallback_reply(
    ...
    *,
    ...
    nepali = {
        ...
        "correction": "Maaf garnuhos. Agi ko jawaf confusing bhayo. Ke chahiyo — package, price, coverage, wa support?",
        ...
        "meta": "Ma AI employee hu. Internet, coverage, ra support ko barema madat garchhu.",
        "follow_up": "Thik cha. Package, coverage, price, wa support — ke chahiyo?",
    ...
    english = {
        ...
        "correction": "Sorry for the confusion. What do you need — package, price, coverage, or support?",
        ...
        "meta": "I am an AI employee. I help with internet, coverage, and support.",
        "follow_up": "Sure. What do you need — packages, coverage, pricing, or support?",
